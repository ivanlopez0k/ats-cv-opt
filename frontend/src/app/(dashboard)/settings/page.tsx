...
import { User, AtSign, MapPin, Briefcase, Building2, Globe } from 'lucide-react';
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-card">
            <CardHeader>
              ...
              <CardDescription className="text-muted-foreground">Datos básicos de tu perfil</CardDescription>
            </CardHeader>
          ...
          <Card className="bg-card">
            ...
            <CardContent className="space-y-6">
              ...
              <Button onClick={handleSaveProfile} disabled={isLoading} variant="outline" className="border-border text-foreground hover:bg-secondary">
